        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="dropdown nav-item">
            <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
              <i class="material-icons">apartment</i> Alquileres
            </a>
            <div class="dropdown-menu dropdown-with-icons">
              <a href="./edificios.html" class="dropdown-item">
                <i class="material-icons">apartment</i> Edificios
              </a>
              <a href="./pisos.html" class="dropdown-item">
                <i class="material-icons">meeting_room</i> Pisos
              </a>
              <a href="./locales.html" class="dropdown-item">
